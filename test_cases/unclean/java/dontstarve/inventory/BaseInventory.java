...
public interface BaseInventory {
     ...
     * @param field a mező
     */
    void collectItem(Field field);

    /**
     * Csökkenti a kézben lévő fáklya életét, ha van a kezében.
     */
    void decreaseTorchDuration();
     ...
     * @return null, ha elfért az inventoryban (vagy nem tudtuk lekraftolni), különben az item
     */
    AbstractItem craftItem(ItemType itemType);
    ...
    /**
     * Megadja, hogy van-e nála kaja.
     * @return ha van akkor az indexe, különben -1
     */
    int hasFood();
